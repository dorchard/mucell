...
namespace MuCell.Model
{
    ...
    public class CellInstance : ICloneable
    {
        ...
        public CellDefinition CellInstanceDefinition
        {
            ...
            set
            {
                cellInstanceDefinition = value;
                SBML.Model model = cellInstanceDefinition.getModel();
                if (model != null)
                {
                    this.species = cellInstanceDefinition.getModel().listOfSpecies;
                }
                ...
                foreach (SBML.Reaction reaction in model.listOfReactions)
                {
