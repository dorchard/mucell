...
namespace MuCell.Model.SBML.Reader
{
    public class SBMLReader
    {
        ...
        private String spatialParametersFlag = "";
        ...
        public void AnnotationElement(Hashtable attrs)
        {
            if (attrs.ContainsKey("xmlns"))
            {
                if ((String)attrs["xmlns"] == "http://example.com/MuCell/Reaction")
                {
                    this.spatialParametersFlag = "reaction";
                }
                else if ((String)attrs["xmlns"] == "http://example.com/MuCell/Species")
                {
                    this.spatialParametersFlag = "species";
                }
            }
        }
        ...
        {
            if (this.spatialParametersFlag == "species")
            {
            ...
            else if (this.spatialParametersFlag == "reaction")
            {
                Reaction reaction = this.model.listOfReactions[this.model.listOfReactions.Count - 1];
                reaction.xPosition = float.Parse((String)attrs["value"]);
            }
        ...
        public void YPositionElement(Hashtable attrs)
        {
            ...
            {
                Reaction reaction = this.model.listOfReactions[this.model.listOfReactions.Count - 1];
                reaction.yPosition = float.Parse((String)attrs["value"]);
            }
        }
