...
namespace MuCell.View
{
        ...
        : UserControl, ISpatialConfigurationPanelUI
    {
        ...
        private NumericUpDown viscosityNumericUpDown;
        private CheckBox collisionsCheckBox;
...
//        }
        ...
        private void viscosityNumericUpDown_ValueChanged(object sender, EventArgs e)
        {
            spatialViewState.InitialSimState.SimulationEnvironment.Viscosity = (float)viscosityNumericUpDown.Value;
        }

        private void collisionsCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            spatialViewState.InitialSimState.SimulationEnvironment.EnableCellCollisions = collisionsCheckBox.Checked;
        }
