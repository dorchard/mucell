...
namespace MuCell.Controller
{
    ...
    public class ApplicationController 
    {
        ...
        Analyzer3DViewPanelController analyzer3DViewPanelController;
        ...
        {
            int experimentID = getNextHighestExperimentID();
        ...
        private int getNextHighestExperimentID()
        {
            int highestID = 0;
        ...
        public void refreshTreeElements()
        {
            experimentTreePanelController.refreshTreeElements(getExperiments());
        }
        public void addExperiment(Experiment experiment)
        {
            //change ID if it overlaps
            int nextID = getNextHighestExperimentID();
            experiment.Id = nextID;
            experiment.Name = "Experiment " + nextID;
            openExperiments.Add(experiment);
...
>>>>>>> .r398
        ...
        public void switchToSimulation(string name)
        {
                ...
                if (experiment.Id == currentExperimentID)
                {
                    ...
                    foreach (Simulation sim in experiment.getSimulations())
                    {
                        ...
                        if (sim.Name.Equals(name))
                        {
                            ...
                            analyzer3DViewPanelController.setSelectedSimulation(sim);
            ...
            Console.WriteLine("switched to simulation "+name);
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            analyzer3DViewPanelController.timer1Tick();
